  ...
  return [
    {
      ...
      previewUrl: 'https://picsum.photos/seed/community-country-night-preview/240/240',
    ...
    },
    {
      ...
      previewUrl: 'https://picsum.photos/seed/community-sertanejo-preview/240/240',
  ...
  updateCommunity(communities, communityId, patch) {
    const next = deepClone(communities).map((community) => {
      ...
      return {
        ...
        previewUrl: patch.previewUrl ?? community.previewUrl,
